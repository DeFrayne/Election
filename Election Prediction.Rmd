...
##########################
Unemployment <- read.csv("/Users/lizzy/Desktop/Project/Election-master/Data/State Data/Unemployment Data/Unemployment.csv", 
                              stringsAsFactors=FALSE)
Unemployment_2020 <- read.csv("/Users/lizzy/Desktop/Project/Election-master/Data/State Data/Unemployment Data/Unemployment_2020.csv", 
                              stringsAsFactors=FALSE)
Density_1970to2020 <- read.csv("/Users/lizzy/Desktop/Project/Election-master/Data/State Data/Population Density /density_1910_2020.csv", 
                              stringsAsFactors = FALSE, skip=3)
Density2 <- read.csv("/Users/lizzy/Desktop/Project/Election-master/Data/State Data/Population Density /density_1910_2020_2.csv", 
                     stringsAsFactors = FALSE, skip=3)
...
New_Data <- inner_join(State_Data, Unemp_Data)
...
New_State_Model <- train(incvote ~ q2gdp + juneapp + inc1 + Change,
                             data = New_Data,
...
Density2$X1950 = as.numeric(gsub("," ,"", Density2$X1950))
Density2$X1960 = as.numeric(gsub("," ,"", Density2$X1960))
Density2$X1970 = as.numeric(gsub("," ,"", Density2$X1970)) 
Density2$X1980 = as.numeric(gsub("," ,"", Density2$X1980)) 
Density2$X1990 = as.numeric(gsub("," ,"", Density2$X1990)) 
Density2$X2000 = as.numeric(gsub("," ,"", Density2$X2000)) 
Density2$X2010 = as.numeric(gsub("," ,"", Density2$X2010)) 
Density2$X2020 = as.numeric(gsub("," ,"", Density2$X2020)) 
...
for (i in 1:52){
  DenState       <- as.numeric(Density2[i, 2:9])
  ...
  if (i==1){
    StateVariable = rep(Density2[1,1], 17)
    NewDensity = cbind(StateVariable, df)
  }else{
    StateVariable = rep(Density2[i,1], 17)
...
New_Data<- inner_join(New_Data, NewDensity3)
...
#Create the regression model for 2016 prediction; notice that juneapp does not correlate, so this will provide
#a good excuse for using polling for a prior and removing this variable from our state-based model later
New_State_Model_1 <- train(incvote ~ q2gdp  + inc1 + Change + DenState,
                         data = New_Data,
                         trControl = Train_Control,
                         #tuneGrid = Tune_Grid, for glmnet
                         method="glm")
