...
# Possible State Variables to add to model
State_Unemployment <- read.csv("/Users/lizzy/Desktop/Project/Election-master/Unemployment.csv", stringsAsFactors=FALSE)


# Create new data set with election year data 
years <- seq(1976, 2020, by=4)
Unemp_Data <- State_Unemployment %>%
...
# add new column for rate change using every year but 1976
...
# combine unemployment data with State Data
...
State_Model <- train(incvote ~ q2gdp + juneapp + inc1 + Change,
                             data = New_Data,
